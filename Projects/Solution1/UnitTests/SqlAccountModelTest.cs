...
namespace Core.IntegrationTests
{
    ...
    public class SqlAccountModelTest
    {
        private SqlAccountModel sut = new SqlAccountModel();

        public SqlAccountModelTest()
        {
        ...
        [Fact]
        [Trait("Core.Sql", "Integration Test")]
        public void Update_NullParameter_ShouldNotAddAccount()
        {
            //arrange
